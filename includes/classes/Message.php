...
class Message {
	...
	public function getConvosDropDown($data, $limit)
	{
		...
		foreach ($convos as $username)
		{
			...
			<div class='convo_body' style='".$style."'><span>
				".$user_found_obj->getUsername()."</span> &middot; " .$latest_message_details[2]."
							<p id='grey' style='margin:2px 0px;'>".$latest_message_details[0]. $split."
							</p>
			</div>
		...
		if($count>$limit)
		{
			...
			$return_string .= "<input type='hidden' class='noMoreDropDownDate' value='true'> <p style='text-align:center; margin:30px;'>No more messages to load!<br><a href='messages.php?u=new'>Text a friend!</a></p> ";
		}
