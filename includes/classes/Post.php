			...
			while($row = mysqli_fetch_array($data_query)) {
				...
				if($user_logged_obj->isFriend($added_by))
				{
					...
					if($userLoggedIn == $added_by)
						$delete_button = "<button class='delete_button' id='post$id' style='border: none; background: #fff;font-size: 24px;color: #999;margin: 2px;'> &times; </button>";
					else
						$delete_button="";
					...
					$str .= "<div class='main_column column cursorp' onClick='javascript:toggle$id()'>
							<div class='media'>
							  ...
							  <div class='deleteB' style='float:right;'>
					    				$delete_button
					    			</div>
